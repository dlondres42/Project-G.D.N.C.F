...
# lasting collectible
attack_col_center = (
    platform5.rect.center[0], platform5.rect.center[0]-65)
attack_col = obj.LastingCollectible(
...
double_jump_col_center = (
    platform23.rect.center[0], platform23.rect.center[1]+42)
double_jump_col = obj.LastingCollectible(center_posit=double_jump_col_center)

# enemies
ghost1 = obj.Enemy(cons.ghost1_x, cons.ghost1_end, cons.ghost1_y, cons.ghost1_vel)
ghost2 = obj.Enemy(cons.ghost2_x, cons.ghost2_end, cons.ghost2_y, cons.ghost2_vel)
...
all_sprites = {
    1: {'floors':       pg.sprite.Group(full_ground, platform1, platform2,
                                        ...
                                        platform9),
        'collectibles': pg.sprite.Group(attack_col),
        'enemies':      pg.sprite.Group()
        },
    2: {'floors':       pg.sprite.Group(movable_plat, full_ground, platform10, platform11,
        ...
        'enemies':      pg.sprite.Group(ghost1, ghost2)
        },
