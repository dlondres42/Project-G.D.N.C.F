...
platform = pg.image.load('images/ground final 1.png')
...
snowflake = pg.image.load('images/floco.png')
heart = pg.image.load('images/coracao.png')
shield = pg.image.load('images/shield.png')
coin = pg.image.load('images/moeda.png')
