...
pg.mixer.music.play(-1)
pg.mixer.music.set_volume(0)     # set to 0.15
...
while True:
    ...
    if not game_over:
        ...
        if sp.attack_col.collected:
            funcs.draw_text(DISPLAYSURF, "ATTACK ENABLED", (10, 10))
        if sp.double_jump_col.collected:
            funcs.draw_text(DISPLAYSURF, "DOUBLE JUMP ENABLED", (10, 40))
        ...
        funcs.draw_text(DISPLAYSURF, "HP is 0: game over. Click enter button to exit.", ref_rect=DISPLAYSURF.get_rect())
