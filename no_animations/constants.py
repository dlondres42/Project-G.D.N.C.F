...
# COORDINATES
# player
player_area = (30, 40)    # witdh and height of player
player_init_posit = (10, height-player_area[1]-50)
...
# BOOLEANS
# controls whether the level will change when the player reaches
# some of the screen limits
level_can_change = False
