...
coin2 = obj.TemporaryCollectible(0, cons.coin2)
coin3 = obj.TemporaryCollectible(0, cons.coin3)
coin4 = obj.TemporaryCollectible(0, cons.coin4)
coin5 = obj.TemporaryCollectible(0, cons.coin5)
...
# temporary collectibles
coin6 = obj.TemporaryCollectible(0, cons.coin6)
coin7 = obj.TemporaryCollectible(0, cons.coin7)
coin8 = obj.TemporaryCollectible(0, cons.coin8)
coin9 = obj.TemporaryCollectible(0, cons.coin9)
...
# collectible
last_col = obj.LastingCollectible(
...
# temporary collectibles
coin10 = obj.TemporaryCollectible(0, cons.coin10)
coin11 = obj.TemporaryCollectible(0, cons.coin11)
coin12 = obj.TemporaryCollectible(0, cons.coin12)
coin13 = obj.TemporaryCollectible(0, cons.coin13)
...
all_sprites = {
    1: {'floors':       pg.sprite.Group(full_ground, platform1, platform2,
                                        ...
                                        platform9),
        'collectibles': pg.sprite.Group(attack_col, coin1, coin2, coin3, coin4, coin5),
    ...
    2: {'floors':       pg.sprite.Group(full_ground, platform10, platform11,
                                        ...
                                        ceiling),
        'collectibles': pg.sprite.Group(coin6, coin7, coin8, coin9),
    ...
    3: {'floors':       pg.sprite.Group(movable_plat, half_ground_1, half_groun_2, left_wall,
                                        ...
                                        ceiling),
        'collectibles': pg.sprite.Group(coin10, coin11, coin12, coin13),
