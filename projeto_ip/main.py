...
# uncomment to go to straight level 3
# sp.level.change()
# sp.level.change()
...
# text objects
font_30 = pg.font.Font(None, 30)    # size 30
font_40 = pg.font.Font(None, 40)    # size 40
font_60 = pg.font.Font(None, 70)    # size 60
...
pg.mixer.music.play(-1)
pg.mixer.music.set_volume(0.1)     # set to 0.05 or 0.1
...
while True:
    ...
    if not game_over and not game_won:
        ...
        funcs.draw_text(font_40, DISPLAYSURF, "CONGRATULATIONS, YOU'VE WON THE GAME!",
