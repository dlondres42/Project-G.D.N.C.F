...
# coin sound
coin_sound = pg.mixer.Sound('music/smw_coin.wav')
coin_sound.set_volume(0.8)
# health sound
heart_sound = pg.mixer.Sound('music/smw_1-up.wav')
heart_sound.set_volume(0.8)
# snowflake sounde
ice = pg.mixer.Sound('music/smw2_pause.wav')
ice.set_volume(0.4)
...
class Level():
    ...
    def draw(self, surface):
        for floor in self.floors:
            surface.blit(ani.platform, floor.rect, (0, 0, floor.rect.width, floor.rect.height))
        self.enemies.update()
